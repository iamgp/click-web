...
def _click_to_tree(ctx: click.Context, node: click.Command | click.MultiCommand, ancestors: list | None = None):
    """
    ...
    if res["is_group"]:
        ...
        for child in children:
            res_childs.append(_click_to_tree(ctx, child, ancestors[:] + [node]))  # noqa: PERF401
    ...
    root = click_web._flask_app.config["APPLICATION_ROOT"].rstrip("/")  # noqa: SLF001
